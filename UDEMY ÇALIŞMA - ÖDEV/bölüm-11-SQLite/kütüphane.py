...
class Kütüphane():
    ...
    def baglanti_olustur(self):
        ...
        self.baglanti = sqlite3.connect("g:/PYTHON/UDEMY ÇALIŞMA - ÖDEV/bölüm-11-SQLite/kütüphane.db")
    ...
    def kitap_sil(self,isim):
        ...
        if len(kitaplar) == 0:
            print("Böyle bir kitap zaten yok...")

        else:
            sorgu1 = "Delete From kitaplar where isim = ?"
